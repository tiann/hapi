...
export const PING_PEER_TOOL_DESCRIPTION =
    ...
    'Delivery is steer-tagged: on steerable flavors (codex / pi / cursor ACP) the message is injected into the peer\'s running turn when one is active, otherwise it becomes the peer\'s next prompt. ' +
