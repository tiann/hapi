export const RPC_METHODS = {
    ...
    StatFiles: 'statFiles',
    MoveFileToRecycleBin: 'moveFileToRecycleBin',
    ListRecycleBin: 'listRecycleBin',
    ReadRecycleBinEntry: 'readRecycleBinEntry',
    RestoreRecycleBinEntry: 'restoreRecycleBinEntry',
    PurgeRecycleBinEntry: 'purgeRecycleBinEntry',
