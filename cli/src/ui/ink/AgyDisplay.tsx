...
export const AgyDisplay: React.FC<AgyDisplayProps> = ({
    messageBuffer,
    logPath,
    onExit,
    onSwitchToLocal
        ...
        <Box flexDirection="column" width={terminalWidth} height={terminalHeight}>
            ...
            >
                <Box flexDirection="column" marginBottom={1}>
                    <Text color="gray" bold>Antigravity agy Agent Messages</Text>
                ...
                <Box flexDirection="column" alignItems="center">
                    {actionInProgress === 'exiting' ? (
                        ...
                        <Text color="green" bold>
                            Antigravity agy running {onSwitchToLocal ? '(Space to switch to local, Ctrl-C to exit)' : '(Ctrl-C to exit)'}
                        </Text>
                    )}
