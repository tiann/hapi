...
describe('getProjectPath', () => {
    ...
    it('should replace slashes with hyphens in the project path', () => {
        const workingDir = '/Users/example/projects/my-app';
        const result = getProjectPath(workingDir);
        expect(result).toBe(join('/home/user', '.claude', 'projects', '-Users-example-projects-my-app'));
    });

    it('should replace dots with hyphens in the project path', () => {
        const workingDir = '/Users/example/projects/app.test.js';
        const result = getProjectPath(workingDir);
        expect(result).toBe(join('/home/user', '.claude', 'projects', '-Users-example-projects-app-test-js'));
    });
    ...
    describe('CLAUDE_CONFIG_DIR support', () => {
        ...
        it('should use CLAUDE_CONFIG_DIR when set', () => {
            ...
            const workingDir = '/Users/example/projects/my-app';
            const result = getProjectPath(workingDir);
            expect(result).toBe(join('/custom/claude/config', 'projects', '-Users-example-projects-my-app'));
        });
        ...
        it('should handle relative CLAUDE_CONFIG_DIR path', () => {
            ...
            const workingDir = '/Users/example/projects/my-app';
            const result = getProjectPath(workingDir);
            expect(result).toBe(join('./config/claude', 'projects', '-Users-example-projects-my-app'));
        });
