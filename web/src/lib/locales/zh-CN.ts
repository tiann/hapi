export default {
  ...
  'settings.voice.provider': '语音服务',
  'settings.voice.language': '语音语言',
  'settings.voice.autoDetect': '自动检测',
  'settings.voice.geminiApiKey': 'Gemini API Key',
  'settings.voice.geminiApiKeyPlaceholder': '留空则使用服务器配置',
  'settings.voice.geminiApiKeyHint': '可选。覆盖服务器端的 GEMINI_API_KEY。',
  'settings.voice.geminiUrl': 'API / 代理 URL',
  'settings.voice.geminiUrlPlaceholder': 'googleapis.com 或 CF Workers 地址',
  'settings.voice.geminiUrlHint': '可选。填入 CF Workers 代理地址，留空则直连 Google API。',
