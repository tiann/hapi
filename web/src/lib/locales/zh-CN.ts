export default {
  ...
  'settings.chat.steerBehavior': '追加指令时',
  'settings.chat.steerBehavior.queue': '排队，等本轮结束',
  'settings.chat.steerBehavior.steer': '引导当前这一轮',
  'settings.chat.steerBehavior.hint': '发送快捷键加上 Ctrl（⌘）可对单条消息临时用另一种方式。仅 Claude 会话生效。',
