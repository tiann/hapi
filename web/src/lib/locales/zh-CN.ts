export default {
  ...
  'message.rewind.fallbackTitle': '暂时无法回退',
  'message.rewind.fallbackDescription': '由于 Codex 原生对话边界存在歧义，HAPI 没有修改当前会话。\n是否改为在此处创建新会话？当前会话不会被修改。',
  'message.rewind.fallbackFork': '在此处分叉',
  'message.rewind.fallbackForking': '分叉中…',
  ...
  'sessions.markAllRead.description': '这会将当前设备上的 {count} 个未读会话标记为已读。',
  'sessions.markAllRead.confirm': '确定',
  'sessions.markAllRead.confirming': '标记中…',
  ...
  'settings.usageQuery.title': 'Agent 额度查询',
  'settings.usageQuery.summary': 'Runner 侧 5H/7D 额度模板',
  'settings.usageQuery.description': '为 Claude Code、Codex 和 Kimi CLI 配置安全的声明式模板，内置 Kimi、ZenMux、智谱 GLM 和 MiniMax 适配。请求在选定的 Runner 上执行，API Key 不会进入 Web 或 Hub 数据库。',
  'settings.usageQuery.target': '额度查询目标',
  'settings.usageQuery.machine': '机器',
  ...
  'settings.usageQuery.loadingMachines': '正在加载机器…',
  'settings.usageQuery.noMachines': '没有在线机器',
  'settings.usageQuery.configuration': '额度查询配置',
  'settings.usageQuery.loading': '正在加载 Runner 设置…',
  'settings.usageQuery.loadFailed': '无法加载 Runner 设置',
  'settings.usageQuery.loadingQuota': '正在加载额度…',
  'settings.usageQuery.quotaUnavailable': '额度查询不可用',
  'settings.usageQuery.loadingWindows': '正在加载 5H/7D 额度…',
  'settings.usageQuery.quotaFailed': '额度查询失败',
  'settings.usageQuery.quota': '额度：',
  'settings.usageQuery.enabled': '启用额度查询',
  'settings.usageQuery.enabledDescription': '启用后，打开会话上下文浮窗时可按需查询 5 小时和 7 天额度。',
  'settings.usageQuery.baseUrlDescription': 'Runner 从所选 Agent 的配置中解析。',
  'settings.usageQuery.apiKeyDescription': '仅在 Runner 侧解析，不会返回浏览器。',
  'settings.usageQuery.configured': '已配置',
  'settings.usageQuery.notConfigured': '未配置',
  'settings.usageQuery.template': '模板',
  'settings.usageQuery.templateDescription': '通用/自定义适配器可编辑请求头和 JSON 路径；经过审查的适配器使用固定响应解析器。只允许请求配置的 Base URL 来源。',
  'settings.usageQuery.templateEditor': '额度查询模板 JSON',
  'settings.usageQuery.invalidTemplate': '模板 JSON 无效或缺少必需字段。',
  'settings.usageQuery.testing': '测试中…',
  'settings.usageQuery.test': '测试',
  'settings.usageQuery.saving': '保存中…',
  'settings.usageQuery.save': '保存',
  'settings.usageQuery.testResult': '测试结果',
  'settings.usageQuery.testFailed': '额度查询失败',
  'settings.usageQuery.saveFailed': '无法保存额度查询设置',
  'settings.usageQuery.documentation': '文档',
  'settings.usageQuery.hapiDocs': 'HAPI 额度查询指南',
  'settings.usageQuery.open': '打开',
  ...
  'settings.general.sessionSummaryInChat.desc': '只影响聊天和复制内容中的显示，不影响摘要生成、通知或后台工作记录。开启后显示状态行，关闭后隐藏；已存储消息保持不变。',
  ...
  'settings.display.openExternalLinksInNewTab.desc': '关闭(默认)保留当前行为。开启后外部链接会在单独的浏览器标签页中打开。',
