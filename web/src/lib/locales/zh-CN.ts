export default {
  ...
  'composer.textContext.button': '添加临时上下文',
  'composer.textContext.title': '添加临时上下文',
  'composer.textContext.description': '将辅助内容保存为文本附件，然后在消息输入框中填写本次问题。',
  'composer.textContext.name': '名称',
  'composer.textContext.namePlaceholder': '可选的附件名称',
  'composer.textContext.content': '上下文',
  'composer.textContext.placeholder': '在此粘贴或输入辅助上下文',
  'composer.textContext.stats': '{characters} 个字符 · {lines} 行',
  'composer.textContext.add': '添加为上下文',
  'composer.textContext.adding': '正在添加…',
  'composer.textContext.addFailed': '添加临时上下文失败',
  'message.user.expand': '展开全文',
  'message.user.collapse': '收起',
  ...
  'settings.chat.textContext.characterThreshold': '自动附件字符阈值',
  'settings.chat.textContext.characterThreshold.desc': '粘贴文本达到该字符数时，自动转换为 UTF-8 .txt 附件。',
  'settings.chat.textContext.lineThreshold': '自动附件行数阈值',
  'settings.chat.textContext.lineThreshold.desc': '粘贴文本超过该行数时，自动转换为 UTF-8 .txt 附件。',
  'settings.chat.textContext.characters': '字符',
  'settings.chat.textContext.lines': '行',
  ...
  'settings.chat.composerToolbar.item.textContext': '添加临时上下文',
