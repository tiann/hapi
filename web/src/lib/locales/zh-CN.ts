export default {
  ...
  'dashboard.allSessions': '全部会话（{n}）',
  'dashboard.allSessionsShort': '全部 {n}',
  'dashboard.viewAllSessions': '查看全部会话',
  'dashboard.newSession': '新建会话',
  'dashboard.browseWorkspace': '浏览 workspace',
  'dashboard.settings': '设置',
  'dashboard.thinking': '思考中',
  'dashboard.waiting': '⚠ 等待中',
  'dashboard.pinSession': '固定会话',
  'dashboard.unpinSession': '取消固定',
  'dashboard.clickToPin': '点击固定并聊天',
  'dashboard.clickToUnpin': '点击取消固定',
  'dashboard.removeFromDashboard': '从仪表板移除',
  'dashboard.selectToPin': '选择第 {n} 个要固定的会话',
  'dashboard.replacePinTitle': '已达固定上限',
  'dashboard.replacePinBody': '已固定 4 个会话（上限）。请选择要取消固定并替换的会话：',
  'dashboard.sessions': '会话（{n}）',
  'dashboard.archiveAll': '全部归档',
  'dashboard.deleteArchived': '删除已归档',
  'dashboard.archiveAllTitle': '归档所有活跃会话',
  'dashboard.deleteAllTitle': '删除所有已归档会话',
  'dashboard.confirmArchive': '归档 {n} 个会话？',
  'dashboard.confirmDelete': '删除 {n} 个已归档会话？',
  'dashboard.confirm': '确认',
  'dashboard.cancel': '取消',
  'dashboard.newSessionIn': '在 {project} 中新建会话',
