export default {
  ...
  'scratchlist.empty': '空',
  'scratchlist.count.one': '1条',
  'scratchlist.count.other': '{n}条',
  'scratchlist.attachmentOnly': '（附件）',
  'scratchlist.emptyHint': '在此暂存笔记、草稿或想法，不会自动发送。',
  'scratchlist.drawerHint': '使用下方输入框添加草稿。单击文字块可编辑，长按并拖动可重新排序。',
  'scratchlist.drawerHintAriaLabel': '显示草稿夹使用说明',
  ...
  'scratchlist.action.editEntry': '编辑草稿夹条目',
  'scratchlist.action.dragToReorder': '长按并拖动以重新排序',
  'scratchlist.action.copy': '复制文字',
  'scratchlist.action.copied': '已复制',
  'scratchlist.action.delete': '删除条目',
  'scratchlist.action.more': '更多操作',
  'scratchlist.action.menuAriaLabel': '草稿条目操作',
  'scratchlist.action.sendNow': '立即发送',
  'scratchlist.action.scheduleSend': '定时发送',
  'scratchlist.confirmDelete.title': '删除草稿？',
  'scratchlist.confirmDelete.description': '确定要删除这条草稿吗？此操作无法撤销。',
  'scratchlist.confirmDelete.attachmentTitle': '删除附件？',
  'scratchlist.confirmDelete.attachmentDescription': '确定要删除附件“{name}”吗？此操作无法撤销。',
