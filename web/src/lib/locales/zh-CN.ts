export default {
  ...
  'tool.exitPlanMode.title': '执行计划',
  'tool.exitPlanMode.badge': '实现方式',
  'tool.exitPlanMode.prompt': '选择退出计划模式后如何开始实现。',
  ...
  'tool.exitPlanMode.clearContext.description': '在新的 Claude 会话中开始实现。',
  'tool.exitPlanMode.permissionMode.prompt': '选择实现时的权限模式。',
  'tool.exitPlanMode.permissionMode.default.title': '标准',
  'tool.exitPlanMode.permissionMode.default.description': '每个操作都需要确认。',
  'tool.exitPlanMode.permissionMode.acceptEdits.title': '自动编辑',
  'tool.exitPlanMode.permissionMode.acceptEdits.description': '自动批准文件编辑，其他操作需要确认。',
  'tool.exitPlanMode.permissionMode.bypassPermissions.title': 'YOLO',
  'tool.exitPlanMode.permissionMode.bypassPermissions.description': '自动批准所有操作，无需确认。',
