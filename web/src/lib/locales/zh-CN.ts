export default {
  ...
  'agentImport.tooltip': '从整个 estate 的在线 runner 将代理会话导入 Hapi',
  ...
  'agentImport.hubLocalScopeHint': '通过 machine RPC 扫描全部在线 runner 并合并结果。无需选择机器——每条会话保留所属 runner 供导入。',
  ...
  'cursorSync.confirm.loading': '正在从在线 runner 加载 Cursor 聊天…',
  'cursorSync.confirm.empty': '在线 runner 上未找到 Cursor 聊天',
  'cursorSync.confirm.emptyForWorkdir': '在线 runner 该工作目录下没有 Cursor 聊天',
  ...
  'claudeSync.confirm.description': '从整个 estate 的在线 runner 选择需要导入到 Hapi 的 Claude 会话',
  'claudeSync.confirm.selectAll': '全选',
  'claudeSync.confirm.clearAll': '全取消',
  'claudeSync.confirm.selectedCount': '已选择 {n} 个会话',
  'claudeSync.confirm.empty': '在线 runner 上未找到 Claude 会话',
  ...
  'claudeSync.confirm.emptyForWorkdir': '在线 runner 此工作目录下没有 Claude 会话',
  'claudeSync.confirm.confirm': '导入',
  'claudeSync.confirm.confirming': '导入中…',
  'claudeSync.confirm.loading': '正在从在线 runner 读取 Claude 会话…',
