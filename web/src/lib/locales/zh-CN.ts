export default {
  ...
  'runner.skew.banner.summaryBody': '此 Hub 可将已连接的运行器升级到匹配版本。可对每台主机点 Upgrade，或等待自动尝试。可最小化或 snooze 本横幅以操作下方会话。',
  ...
  'settings.general.runnerMgmt.title': '运行器管理',
  'settings.general.runnerMgmt.body': '本 Hub 可以让已连接的运行器保持与自身相同的 HAPI CLI 版本。当 Hub 升级时，运行器会自行更新以匹配 — 无需 SSH，每个运行器自行安装。',
  'settings.general.runnerMgmt.policyLabel': '当运行器版本与 Hub 不一致时',
  'settings.general.runnerMgmt.policySilent': '不提醒',
  'settings.general.runnerMgmt.policySilentHint': '忽略差异',
  'settings.general.runnerMgmt.policyAlert': '提醒',
  'settings.general.runnerMgmt.policyAlertHint': '显示横幅；手动升级',
  'settings.general.runnerMgmt.policyAuto': '自动升级',
  'settings.general.runnerMgmt.policyAutoHint': '自动帮我升级',
  'settings.general.runnerMgmt.optOutLabel': '想让某个运行器版本高于 Hub？',
  'settings.general.runnerMgmt.optOutBody': '自动升级会把运行器拉回与 Hub 一致，因此刻意更新的运行器会被降级。若要让某个运行器保持更高版本，请在上方选择“不提醒”或“提醒”（影响整个集群），或仅在该运行器上设置 HAPI_DISABLE_VERSION_HANDOFF=1 并重启它。在 Hub 上设置 HAPI_UPGRADE_CHANNEL=off 会完全禁用所有升级。',
