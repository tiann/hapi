export default {
  ...
  'settings.telegram.botToken.placeholder': '从 @BotFather 获取的 Telegram 机器人 Token',
  'settings.telegram.botToken.help': '从 Telegram 的 @BotFather 获取 Token',
  'settings.telegram.publicUrl': '公共 URL',
  'settings.telegram.publicUrl.placeholder': 'https://your-domain.com',
  'settings.telegram.notifications': '通知',
  'settings.telegram.notifications.enabled': '已启用',
  'settings.telegram.notifications.disabled': '已禁用',
  'settings.telegram.save': '保存配置',
  'settings.telegram.saving': '保存中…',
  'settings.telegram.saved': '配置已保存',
  'settings.telegram.saveError': '保存配置失败',
  'settings.telegram.restartRequired': '请重启 Hub 以使更改生效',
  'settings.telegram.tokenSource.env': '来自环境变量',
  'settings.telegram.tokenSource.file': '来自设置文件',
  'settings.telegram.tokenSource.default': '未配置',
  'settings.telegram.removeToken': '移除 Token',
  'settings.telegram.removing': '移除中…',
  'settings.telegram.confirmRemove': '确定要移除 Telegram 机器人 Token 吗？',
