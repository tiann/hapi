export default {
  ...
  'newSession.permissionMode.desc': '选择当前机器已报告支持的沙箱与审批方式。',
  'newSession.provider.experimental': '实验性',
  'newSession.provider.readinessMissing': '无法获取 {agent} 的就绪状态。请更新或重启 HAPI Runner。',
  'newSession.provider.readinessStale': '{agent} 的就绪状态已过期。请更新或重启 HAPI Runner。',
  'newSession.provider.notInstalled': '当前机器未安装 {agent}。',
  'newSession.provider.notAuthenticated': '当前机器上的 {agent} 尚未登录。',
  'newSession.provider.versionUnsupported': '{agent} 版本不受支持，请升级。',
  'newSession.provider.probeFailed': '无法检查 {agent} 的就绪状态。',
  'newSession.provider.modelUnavailable': '当前机器上的 {agent} 不支持所选模型。',
  'newSession.provider.effortUnavailable': '当前机器上的 {agent} 不支持所选思考强度。',
  'newSession.provider.modeUnavailable': '当前机器上的 {agent} 不支持所选权限模式。',
  'newSession.provider.resumeUnavailable': '当前机器上的 {agent} 不支持恢复会话。',
  'newSession.provider.recovery': '请运行：{command}',
  ...
  'session.selectionChangedDuringCreate': '预检期间机器或会话设置发生了变化，请确认后重新创建。',
  ...
  'tool.input': '输入',
  'tool.result': '结果',
  'tool.rawInput': '原始输入载荷',
  'tool.rawResult': '原始结果载荷',
