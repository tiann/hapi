export default {
  ...
  'settings.display.sessionToolbar.title': '会话列表工具栏',
  'settings.display.sessionToolbar.description': '排列侧边栏的可选操作。设置和新建会话保持固定，确保随时可以返回此设置。',
  'settings.display.sessionToolbar.searchLayout': '搜索布局',
  'settings.display.sessionToolbar.searchLayout.icon': '搜索图标',
  'settings.display.sessionToolbar.searchLayout.field': '常驻搜索框',
  'settings.display.sessionToolbar.order': '工具顺序',
  'settings.display.sessionToolbar.previewHint': '拖动工具可排序，或在左侧、右侧和隐藏分组之间移动；选中工具后也可使用下方按钮操作。',
  'settings.display.sessionToolbar.reset': '恢复默认',
  'settings.display.sessionToolbar.hidden': '隐藏工具',
  'settings.display.sessionToolbar.emptyHidden': '将工具拖到这里隐藏',
  'settings.display.sessionToolbar.leftGroup': '左侧分组',
  'settings.display.sessionToolbar.rightGroup': '右侧分组',
  'settings.display.sessionToolbar.moveEarlier': '向前移动',
  'settings.display.sessionToolbar.moveLater': '向后移动',
  'settings.display.sessionToolbar.hide': '隐藏',
  'settings.display.sessionToolbar.show': '显示',
  'settings.display.sessionToolbar.fixedHint': '设置和新建会话为固定操作。仅当 Runner 提供工作区根目录时才显示浏览；存在多台机器时才显示机器筛选。',
  'settings.display.sessionToolbar.dateEmbedded': '日期筛选（此布局下显示在搜索框内）',
  'settings.display.sessionToolbar.item.search': '搜索会话',
  'settings.display.sessionToolbar.item.dateFilter': '日期筛选',
  'settings.display.sessionToolbar.item.machineFilter': '机器筛选',
  'settings.display.sessionToolbar.item.codexImport': '导入 Codex 历史',
  'settings.display.sessionToolbar.item.refresh': '刷新会话',
  'settings.display.sessionToolbar.item.browse': '浏览工作区',
  ...
  'sessions.toolbar.item.refresh': '刷新会话',
