export default {
  ...
  'misc.contextAgentDetails': 'Agent 上下文详情',
  'misc.contextAgentDetailsTitle': 'Agent 详情',
  ...
  'misc.contextWindow': '上下文窗口',
  'misc.contextInput': '输入',
  'misc.contextOutput': '输出',
  'misc.contextCacheRead': '缓存读取',
  'misc.contextCacheWrite': '缓存写入',
  'misc.contextReasoning': '推理',
  'misc.contextSessionTotal': '会话累计',
  'misc.contextProvider': '提供商',
  'misc.contextCategories': '上下文分类',
  'misc.contextResources': '资源',
  'misc.contextMemoryFiles': '记忆文件',
  'misc.contextMemoryFile': '记忆文件',
  'misc.contextSkills': 'Skills',
  'misc.contextAgents': 'Agent',
  'misc.contextMcpTools': 'MCP 工具',
  'misc.contextSystemTools': '系统工具',
  'misc.contextTool': '工具',
  'misc.contextSlashCommands': 'Agent 指令',
  'misc.contextCommand': '命令',
  'misc.contextRuntime': '运行配置',
  'misc.contextSandbox': '沙箱',
  'misc.contextApproval': '权限策略',
  'misc.contextServiceTier': '服务等级',
  'misc.contextInstructionSources': '指令来源',
  'misc.contextMcpServers': 'MCP 服务',
  'misc.contextMcpServer': 'MCP 服务',
  'misc.contextSource': '来源',
  'misc.contextNoDetails': '该 Agent 尚未上报更多上下文详情。',
