export default {
  ...
  'runner.skew.banner.binaryUpdatedHint': '（磁盘上已有更新 CLI — 重启可能加载）',
  'runner.skew.banner.autoUpgradeHint': '可选：磁盘上已有更新 CLI 时由 Hub 自动重启运行器。设置 HAPI_AUTO_UPGRADE_RUNNERS=1（或 settings.json 中 autoUpgradeRunners: true）。默认关闭。不会向远程机器推送安装包。',
