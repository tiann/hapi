export default {
  ...
  'newSession.agentUnavailableReason.notFound': '未安装或不在 PATH 中',
  'newSession.agentUnavailableReason.invalidConfiguration': 'Runner 配置无效',
  ...
  'settings.display.newSession': '新建会话',
  'settings.display.showUnavailableAgents': '显示不可用的 Agent',
  'settings.display.showUnavailableAgents.desc': '当受支持的 Agent 未安装或在所选机器上不可用时，仍在创建会话中显示它们。',
