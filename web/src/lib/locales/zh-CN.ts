export default {
  ...
  'tool.aggregate.readFiles': '读取项目文件',
  'tool.aggregate.searchCode': '搜索代码内容',
  'tool.aggregate.changeCode': '处理代码变更',
  'tool.aggregate.inspectChanges': '检查代码变更',
  'tool.aggregate.coordinateAgents': '协调代理任务',
  'tool.aggregate.runCommands': '处理项目操作',
  ...
  'settings.chat.aggregateToolCardBackground': '聚合工具卡片背景',
  'settings.chat.userMessageBackground': '用户消息背景',
  'settings.color.default': '默认',
  'settings.color.custom': '自定义颜色',
  'settings.color.reset': '恢复默认',
  'settings.color.preview': '预览',
