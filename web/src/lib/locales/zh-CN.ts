export default {
  ...
  'sessions.search.scope.metadata': '默认',
  'sessions.search.scope.content': '内容',
  'sessions.search.scope.toggle': '搜索范围',
  ...
  'session.inChatSearch.open': '在此对话中搜索',
  'session.inChatSearch.openTitle': '在此对话中搜索（Ctrl/Cmd+Shift+F）',
  'session.inChatSearch.inputLabel': '在此对话中查找',
  'session.inChatSearch.placeholder': '在此对话中查找…',
  'session.inChatSearch.minQuery': '请输入至少 2 个字符以搜索消息内容。',
  'session.inChatSearch.loading': '正在搜索此对话…',
  'session.inChatSearch.error': '对话搜索失败。',
  'session.inChatSearch.noResults': '此对话中没有匹配的消息。',
  'session.inChatSearch.results': '{shown}/{total}',
  'session.inChatSearch.roleAssistant': '助手',
  'session.inChatSearch.fueTitle': '在此对话中查找',
  'session.inChatSearch.fueBody': '对当前打开的会话做排序搜索，点选结果即可跳到那一轮。侧边栏「内容」搜索仍用于找出哪个会话。',
  ...
  'misc.locatingMessage': '定位消息中…',
  'misc.searchMatchNavigation': '搜索匹配项导航',
  'misc.searchMatches': '{current}/{total}',
  'misc.previousSearchMatch': '上一个匹配项',
  'misc.nextSearchMatch': '下一个匹配项',
  'misc.closeSearch': '关闭内容搜索',
