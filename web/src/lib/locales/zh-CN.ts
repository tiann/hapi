export default {
  ...
  'dialog.rename.generateErrorWithReason': '标题生成失败：{reason}',
  'dialog.rename.generateProviderErrorWithStatus': '标题生成服务请求失败（HTTP {status}）：{reason}',
  'dialog.rename.generateProviderError': '标题生成服务请求失败：{reason}',
  'dialog.rename.providerReason.requestRejected': '请求被拒绝',
  'dialog.rename.providerReason.authenticationFailed': '身份验证失败',
  'dialog.rename.providerReason.accessDenied': '访问被拒绝',
  'dialog.rename.providerReason.endpointOrModelNotFound': '端点或模型不存在',
  'dialog.rename.providerReason.requestTimedOut': '请求超时',
  'dialog.rename.providerReason.rateLimited': '请求过于频繁',
