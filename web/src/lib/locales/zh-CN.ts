export default {
  ...
  'newSession.profile': '启动模板',
  'newSession.profile.none': '不使用模板',
  'newSession.reasoningEffort': '推理强度',
  'newSession.permissionMode': '权限模式',
  'newSession.permissionMode.default': '默认',
  'newSession.permissionMode.readOnly': '只读',
  'newSession.permissionMode.safeYolo': '安全 YOLO',
  ...
  'settings.codexProfiles.title': 'Codex 启动模板',
  'settings.codexProfiles.machine': '机器',
  'settings.codexProfiles.default': '默认模板',
  'settings.codexProfiles.default.none': '不设置默认模板',
  'settings.codexProfiles.default.badge': '默认',
  'settings.codexProfiles.loading': '正在加载 Codex 模板…',
  'settings.codexProfiles.empty': '这台机器还没有 Codex 模板。',
  'settings.codexProfiles.form.new': '新建模板',
  'settings.codexProfiles.form.edit': '编辑模板',
  'settings.codexProfiles.form.id': '模板 ID',
  'settings.codexProfiles.form.label': '名称',
  'settings.codexProfiles.form.model': '模型',
  'settings.codexProfiles.form.reasoningEffort': '推理强度',
  'settings.codexProfiles.form.reasoningEffort.minimal': '最小',
  'settings.codexProfiles.form.reasoningEffort.low': '低',
  'settings.codexProfiles.form.reasoningEffort.medium': '中',
  'settings.codexProfiles.form.reasoningEffort.high': '高',
  'settings.codexProfiles.form.reasoningEffort.xhigh': '超高',
  'settings.codexProfiles.form.permissionMode': '权限模式',
  'settings.codexProfiles.form.collaborationMode': '协作模式',
  'settings.codexProfiles.form.collaborationMode.default': '默认',
  'settings.codexProfiles.form.collaborationMode.plan': 'Plan',
  'settings.codexProfiles.form.sessionType': '会话类型',
  'settings.codexProfiles.form.unset': '使用启动默认值',
  'settings.codexProfiles.form.create': '创建模板',
  'settings.codexProfiles.form.update': '保存修改',
  'settings.codexProfiles.form.cancel': '重置表单',
  'settings.codexProfiles.form.editAction': '编辑',
  'settings.codexProfiles.form.deleteAction': '删除',
  'settings.codexProfiles.form.validation.idRequired': '模板 ID 不能为空。',
  'settings.codexProfiles.form.validation.labelRequired': '模板名称不能为空。',
  'settings.codexProfiles.form.validation.idDuplicate': '模板 ID 已存在。',
  'settings.codexProfiles.form.saveError': '保存 Codex 模板失败。',
