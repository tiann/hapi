export default {
  ...
  'studio.action.create': '创建工作室',
  'studio.loading': '正在加载工作室…',
  'studio.notFound': '工作室不可用，或分享链接已撤销。',
  'studio.back': '返回会话',
  'studio.owner.title': '主持人控制台',
  'studio.owner.shareLink': '分享链接',
  'studio.owner.copy': '复制',
  ...
  'studio.mode.view': '仅查看',
  'studio.mode.contribute': '允许参与',
  'studio.post.status.open': '待处理',
  'studio.post.status.submitted': '已提交',
  'studio.post.status.dismissed': '已忽略',
  'studio.post.kind.discussion': '讨论',
  'studio.post.kind.suggestion': '建议',
