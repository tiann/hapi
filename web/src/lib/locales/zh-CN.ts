export default {
  ...
  'sessions.group.pin': '置顶分组',
  'sessions.group.unpin': '取消置顶',
  'sessions.group.rename': '重命名分组',
  'sessions.group.more': '更多操作',
  ...
  'dialog.renameGroup.placeholder': '分组名称',
  'dialog.renameGroup.save': '保存',
  'dialog.renameGroup.hint': '仅修改显示名称，目录（{path}）不变。清空后保存可恢复默认名称。',
