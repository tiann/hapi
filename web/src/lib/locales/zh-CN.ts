export default {
  ...
  'codexSync.tooltip': '同步会话到codex客户端',
  'codexSync.confirm.title': '同步会话',
  'codexSync.confirm.description': '是否将会话同步到codex客户端？',
  'codexSync.confirm.confirm': '同步',
  'codexSync.confirm.confirming': '同步中…',
  'codexSync.success.title': '同步完成',
  'codexSync.success.body': '已同步会话内容到codex客户端。',
  'codexSync.error.timeout': '执行超时',
  'codexSync.failed.title': '同步会话失败',
  'codexSync.failed.body': '同步脚本执行失败。',
  'codexSync.failed.bodyWithReason': '同步失败：{reason}',
  'codexSync.restart.title': '同步完成',
  'codexSync.restart.description': '已同步会话内容到codex客户端。\n是否重启 Codex 客户端以刷新会话？',
