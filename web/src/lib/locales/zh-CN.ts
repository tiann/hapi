export default {
  ...
  'settings.general.peerSpawn.agent': '对等 spawn 智能体',
  'settings.general.peerSpawn.agent.desc': 'MCP spawn_peer 与 hapi spawn-peer 未指定 agent 时的默认风味。',
  'settings.general.peerSpawn.permissionMode': '对等 spawn 权限模式',
  'settings.general.peerSpawn.permissionMode.desc': '对等 spawn 的默认权限模式（yolo 会映射到各风味的自动批准等价项）。',
