export default {
  ...
  'newSession.import.entry': '导入现有会话',
  'newSession.import.title': '导入现有会话',
  'newSession.import.description': '浏览本地 Codex 会话，并在不离开 HAPI 的情况下导入或刷新它们。',
  'newSession.import.tabs.claude': 'Claude',
  'newSession.import.claudeSoon': 'Claude 导入即将支持。',
  'newSession.import.searchPlaceholder': '搜索标题、提示词或路径',
  'newSession.import.refreshList': '刷新',
  'newSession.import.loading': '正在加载可导入的 Codex 会话...',
  'newSession.import.retry': '重试',
  'newSession.import.empty': '当前连接机器上没有可导入的 Codex 会话。',
  'newSession.import.emptySearch': '没有匹配搜索条件的会话。',
  'newSession.import.badgeImported': '已导入',
  'newSession.import.badgeReady': '可导入',
  'newSession.import.unknownDirectory': '未知目录',
  'newSession.import.preview': '预览',
  'newSession.import.noPreview': '没有可用的提示词预览。',
  'newSession.import.transcript': '转录文件',
  'newSession.import.open': '在 HAPI 中打开',
  'newSession.import.refresh': '从源刷新',
  'newSession.import.refreshing': '刷新中...',
  'newSession.import.cta': '导入到 HAPI',
