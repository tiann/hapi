export default {
  ...
  'newSession.import.description': '浏览本地 Codex 或 Claude 会话，并在不离开 HAPI 的情况下导入或重新导入它们。',
  'newSession.import.tabs.claude': 'Claude',
  'newSession.import.searchPlaceholder': '搜索标题、提示词或路径',
  'newSession.import.refreshList': '刷新',
  'newSession.import.loading': '正在加载可导入的会话...',
  'newSession.import.retry': '重试',
  'newSession.import.empty': '当前连接机器上没有可导入的会话。',
  ...
  'newSession.import.reimport': '重新从源导入',
  'newSession.import.reimporting': '重新导入中...',
