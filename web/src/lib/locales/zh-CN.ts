export default {
  ...
  // DeepSeek Harness 会话视图
  'dsh.sessionLabel': 'DeepSeek Harness',
  'dsh.running': '运行中',
  'dsh.idle': '空闲',
  'dsh.pendingApprovals': '{count} 个待批准请求',
  'dsh.reasoning': '推理过程',
  'dsh.fork': 'Fork',
  'dsh.forkAtMessage': '从此消息 fork 会话',
  'dsh.forkingTo': '正在打开 fork 的会话',
  'dsh.emptyConversation': '还没有消息 —— 告诉 agent 你想做什么。',
  'dsh.error.unknown': '发生错误。',
  'dsh.loading': '加载中…',
  'dsh.send': '发送',
  'dsh.sending': '发送中…',
  ...
  'dsh.remove': '移除',
  'dsh.jobs': '后台任务',
  'dsh.jobStatus.running': '运行中',
  'dsh.jobStatus.stopping': '停止中',
  'dsh.jobStatus.completed': '已完成',
  'dsh.jobStatus.killed': '已终止',
  'dsh.jobStatus.failed': '失败',
  'dsh.goalStatus.active': '进行中',
  'dsh.goalStatus.paused': '已暂停',
  'dsh.goalStatus.complete': '已完成',
  'dsh.goalStatus.cleared': '已清除',
  'dsh.goalRound': '第 {round} 轮',
  'dsh.goalPause': '暂停',
  'dsh.goalResume': '继续',
  'dsh.goalComplete': '完成',
  'dsh.goalClear': '清除',
  'dsh.questionsTitle': 'Agent 需要你的输入',
  ...
  'dsh.mode.minimal': '极简模式',
  'dsh.mode.cordis': '创造模式',
  'dsh.permission': '权限',
  ...
  'dsh.noSubagents': '还没有子代理。',
  'dsh.subagentRunning': '运行中',
  'dsh.refresh': '刷新',
  'dsh.subagentRunningCount': '{count} 个运行中',
  'dsh.subagentHasChildren': '有子代理',
  'dsh.subagentIdle': '空闲',
  'dsh.toolCall': '工具调用',
  'dsh.toolResult': '工具结果',
