export default {
  ...
  'dshImport.inline.title': '导入 DeepSeek Harness 历史',
  'dshImport.inline.description': '可选：选择已有 DSH 会话，导入历史后继续原会话。',
  'dshImport.inline.clear': '清除',
  'dshImport.inline.choose': '选择历史',
  'dshImport.dialog.title': '导入 DeepSeek Harness 会话',
  'dshImport.dialog.description': '选择 DSH 历史。单选会立即续接，多选会在后台批量导入。',
  'dshImport.dialog.concurrentWarning': 'HAPI 会继续同一个原生 DSH 会话。除非你明确需要共享实时对话，否则不要同时从另一个 DSH 客户端发送消息。',
  'dshImport.loading': '正在读取 DeepSeek Harness 会话…',
  'dshImport.empty': '没有找到可导入的 DeepSeek Harness 会话，请确认 dsh web 正在运行。',
  'dshImport.selectedCount': '已选择 {n} 个',
  'dshImport.clearAll': '全部清除',
  'dshImport.selectAll': '全部选择',
  'dshImport.allDirectories': '全部目录',
  'dshImport.search': '搜索标题、消息、路径、模型或 ID',
  'dshImport.imported': '已导入',
  'dshImport.needsAttention': '需要处理',
  'dshImport.messages': '条记录',
  'dshImport.importing': '正在导入…',
  'dshImport.confirm': '导入',
  'dshImport.success.title': 'DeepSeek Harness 会话已导入',
  'dshImport.success.body': '已导入 {n} 个 DeepSeek Harness 会话。',
  'dshImport.failed.title': 'DeepSeek Harness 导入失败',
  'dshImport.failed.body': '导入 DeepSeek Harness 历史失败。',
