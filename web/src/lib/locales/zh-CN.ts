export default {
  ...
  'dialog.fork.yoloDescription': '运行命令时不询问权限',
  'dialog.fork.confirm': '分支',
  'dialog.fork.success': '会话已成功分支',
  'dialog.fork.error': '会话分支失败',
  'dialog.reload.title': '重载会话',
  'dialog.reload.description': '重新启动会话进程以应用新设置或CLI更新',
  'dialog.reload.yoloLabel': '启用 YOLO 模式',
  'dialog.reload.yoloDescription': '运行命令时不询问权限',
  'dialog.reload.forceLabel': '强制重载',
  'dialog.reload.forceDescription': '立即停止当前操作',
  'dialog.reload.confirm': '重载',
