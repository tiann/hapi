export default {
  ...
  'opencodeSync.inline.title': '导入 OpenCode 历史',
  'opencodeSync.inline.description': '可选：选择本机已有的 OpenCode session，导入历史后继续对话。',
  'opencodeSync.inline.clear': '清除',
  'opencodeSync.inline.choose': '选择历史',
  'opencodeSync.dialog.title': '导入 OpenCode sessions',
  'opencodeSync.dialog.description': '选择本机 OpenCode 历史。单选会立即继续，多选会批量导入到会话列表。',
  'opencodeSync.dialog.concurrentWarning': '多个进程可以同时打开同一个 OpenCode session，但不要从未刷新的副本交替写入。继续在 HAPI 中操作前，请重新加载或关闭其他 OpenCode 进程，避免产生意外分支。',
  'opencodeSync.loading': '正在扫描 OpenCode sessions…',
  'opencodeSync.empty': '没有找到可导入的 OpenCode session。',
  'opencodeSync.selectedCount': '已选择 {n} 个',
  'opencodeSync.clearAll': '全部清除',
  'opencodeSync.selectAll': '全部选择',
  'opencodeSync.allDirectories': '全部目录',
  'opencodeSync.search': '搜索标题、消息、路径或 ID',
  'opencodeSync.imported': '已导入',
  'opencodeSync.importing': '正在导入…',
  'opencodeSync.confirm': '导入',
  'opencodeSync.success.title': 'OpenCode sessions 已导入',
  'opencodeSync.success.body': '已导入 {n} 个 OpenCode sessions。',
  'opencodeSync.failed.title': 'OpenCode 导入失败',
  'opencodeSync.failed.body': '导入 OpenCode 历史失败。',
  'opencodeSync.failed.partial': '{failed} 个 session 导入失败：{reason}',
  'opencodeSync.error.diverged': '本机 OpenCode 分支在上次导入后发生变化，请先检查会话再继续。',
  'opencodeSync.error.active': '请先停止正在运行的 Hapi OpenCode session，再导入新增的原生历史。',
