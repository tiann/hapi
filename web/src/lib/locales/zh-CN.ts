export default {
  ...
  'files.page.openRecycleBin': '打开回收站',
  ...
  'file.page.moveToRecycleBin': '移入回收站',
  ...
  // HAPI 回收站
  'recycleBin.title': 'HAPI 回收站',
  'recycleBin.itemCount': '{count} 个项目',
  'recycleBin.loading': '正在加载回收站…',
  'recycleBin.emptyState': '空',
  'recycleBin.expires': '{date} 过期 · 剩余 {days} 天',
  'recycleBin.preview': '预览',
  'recycleBin.previewLoading': '正在加载预览…',
  'recycleBin.previewUnavailable': '无法预览。',
  'recycleBin.restore': '恢复',
  'recycleBin.restoring': '正在恢复…',
  'recycleBin.purge': '删除',
  'recycleBin.empty': '清空',
  'recycleBin.moveConfirmTitle': '将文件移入回收站？',
  'recycleBin.moveConfirmDescription': '将“{path}”移入 HAPI 回收站，最多可在 {days} 天内恢复。',
  'recycleBin.moveConfirmDescriptionUnknown': '将“{path}”移入 HAPI 回收站，可在配置的保留期限内恢复。',
  'recycleBin.moveConfirm': '移入',
  'recycleBin.moveConfirming': '正在移动…',
  'recycleBin.purgeConfirmTitle': '永久删除文件？',
  'recycleBin.purgeConfirmDescription': '从 HAPI 回收站永久删除“{path}”中的“{name}”，此操作无法撤销。',
  'recycleBin.purgeConfirm': '永久删除',
  'recycleBin.purgeConfirming': '正在删除…',
  'recycleBin.emptyConfirmTitle': '清空回收站？',
  'recycleBin.emptyConfirmDescription': '永久删除 HAPI 回收站中的 {count} 个项目，此操作无法撤销。',
  'recycleBin.emptyConfirm': '清空回收站',
  'recycleBin.emptyConfirming': '正在清空…',
  'recycleBin.restoreConflictTitle': '恢复目标已存在',
  'recycleBin.restoreConflictDescription': '“{path}”中已经存在名为“{name}”的文件，请选择恢复方式。',
  'recycleBin.restoreConflictOverwrite': '覆盖现有文件',
  'recycleBin.restoreConflictNewName': '使用新文件名恢复',
  'recycleBin.restoreConflictCancel': '取消恢复',
  'recycleBin.error.list': '加载 HAPI 回收站失败。',
  'recycleBin.error.move': '将文件移入 HAPI 回收站失败。',
  'recycleBin.error.preview': '预览回收站项目失败。',
  'recycleBin.error.restore': '恢复回收站项目失败。',
  'recycleBin.error.purge': '永久删除回收站项目失败。',
  'recycleBin.error.empty': '清空 HAPI 回收站失败。',
