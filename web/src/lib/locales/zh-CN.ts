export default {
  ...
  'runner.skew.banner.autoUpgradeHint': '可选开关仅表示：当该机器磁盘上已有更新 CLI 时，Hub 可自动 stop-runner。绝不会远程下载或安装软件包。设置 HAPI_AUTO_UPGRADE_RUNNERS=1 或 settings.json 中 autoUpgradeRunners: true（默认关闭）。',
