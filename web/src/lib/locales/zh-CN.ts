export default {
  ...
  'composer.attachmentPicker.title': '添加附件',
  'composer.attachmentPicker.description': '选择附件来源。',
  'composer.attachmentPicker.photos': '相册',
  'composer.attachmentPicker.camera': '拍照',
  'composer.attachmentPicker.files': '文件',
