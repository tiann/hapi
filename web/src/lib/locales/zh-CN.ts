export default {
  ...
  'session.item.prLinked': '已关联',
  'session.item.prChecked': '检查于 {time}',
  'session.item.prStale': '已过期',
  'session.item.prStatus.merged': '已合并',
  'session.item.prStatus.closed': '已关闭',
  'session.item.prStatus.draft': '草稿',
  'session.item.prStatus.checksFailed': '检查失败',
  'session.item.prStatus.conflicts': '有冲突',
  'session.item.prStatus.mergeBlocked': '合并受阻',
  'session.item.prStatus.checksRunning': '检查进行中',
  'session.item.prStatus.unstable': '不稳定',
  'session.item.prStatus.behindBase': '落后主干',
  'session.item.prStatus.readyToMerge': '可合并',
  'session.item.prStatus.mergeable': '可合并',
  'session.item.prStatus.checksPassed': '检查通过',
  ...
  'dialog.linkPr.link': '关联',
  'dialog.linkPr.linking': '关联中…',
