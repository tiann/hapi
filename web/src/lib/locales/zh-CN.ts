export default {
  ...
  'settings.voice.mode': '语音模式',
  'settings.voice.mode.assistant': '语音助手',
  'settings.voice.mode.dictationLocal': '本地转写',
  'settings.voice.mode.dictationElevenLabs': 'ElevenLabs 转写',
