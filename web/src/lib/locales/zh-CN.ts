export default {
  ...
  'settings.general.agents.description': '新建会话与对等 spawn（MCP spawn_peer / hapi spawn-peer）共用的中心级默认值。',
  'settings.general.peerSpawn.agent': '默认智能体',
  'settings.general.peerSpawn.agent.desc': '新建会话与对等 spawn 未指定 agent 时的默认风味。',
  'settings.general.peerSpawn.permissionMode': '默认权限模式',
  'settings.general.peerSpawn.permissionMode.desc': '新建会话与对等 spawn 的默认权限模式（yolo 会映射到各风味的自动批准等价项）。',
  'settings.general.peerSpawn.model': '默认模型',
  'settings.general.peerSpawn.model.desc': '所选智能体的默认模型 id（按风味；失焦后保存）。新建会话与对等 spawn 未指定 model 时使用。',
