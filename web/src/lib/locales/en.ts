export default {
  ...
  'tool.aggregate.inspectFiles': 'Inspect project files',
  'tool.aggregate.readFiles': 'Read project files',
  'tool.aggregate.searchCode': 'Search code',
  'tool.aggregate.changeCode': 'Process code changes',
  'tool.aggregate.inspectChanges': 'Inspect code changes',
  'tool.aggregate.coordinateAgents': 'Coordinate agent tasks',
  'tool.aggregate.runCommands': 'Handle project actions',
  ...
  'settings.chat.aggregateToolCardBackground': 'Aggregate Tool Card Background',
  ...
  'settings.color.preview': 'Preview',
