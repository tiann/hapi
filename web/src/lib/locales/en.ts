export default {
  ...
  'newSession.codexProvider': 'Provider',
  'newSession.codexProvider.placeholder': 'Default, e.g. custom-proxy',
  'newSession.codexProvider.help': 'Codex only. Sets Codex model_provider for the new session.',
  'newSession.codexProfile': 'Profile',
