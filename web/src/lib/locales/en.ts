export default {
  ...
  'settings.voice.mode': 'Voice Mode',
  'settings.voice.mode.assistant': 'Assistant',
  'settings.voice.mode.dictationLocal': 'Local Dictation',
  'settings.voice.mode.dictationElevenLabs': 'ElevenLabs Transcription',
