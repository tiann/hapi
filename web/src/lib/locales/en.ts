export default {
  ...
  'runner.skew.banner.summaryBody': 'This hub can upgrade connected runners to match. Use Upgrade per host, or wait for the automatic attempt. Minimize or snooze this banner to reach sessions underneath.',
  ...
  'settings.general.runnerMgmt.title': 'Runner management',
  'settings.general.runnerMgmt.body': 'This hub can keep connected runners on its own HAPI CLI version. When the hub upgrades, runners self-update to match — no SSH, each runner installs on itself.',
  'settings.general.runnerMgmt.policyLabel': 'When a runner drifts from the hub version',
  'settings.general.runnerMgmt.policySilent': 'No alert',
  'settings.general.runnerMgmt.policySilentHint': 'Ignore drift',
  'settings.general.runnerMgmt.policyAlert': 'Alert',
  'settings.general.runnerMgmt.policyAlertHint': 'Show a banner; upgrade by hand',
  'settings.general.runnerMgmt.policyAuto': 'Auto-upgrade',
  'settings.general.runnerMgmt.policyAutoHint': 'Upgrade runners for me',
  'settings.general.runnerMgmt.optOutLabel': 'Want a runner ahead of the hub?',
  'settings.general.runnerMgmt.optOutBody': 'Auto-upgrade pulls runners back to match the hub, so a deliberately newer runner would be downgraded. To keep one ahead, choose No alert or Alert above (fleet-wide), or set HAPI_DISABLE_VERSION_HANDOFF=1 on just that runner and restart it. HAPI_UPGRADE_CHANNEL=off on the hub disables all upgrades regardless.',
