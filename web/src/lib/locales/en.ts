export default {
  ...
  'sessions.group.pin': 'Pin group to top',
  'sessions.group.unpin': 'Unpin group',
  'sessions.group.rename': 'Rename group',
  'sessions.group.more': 'More actions',
  ...
  'dialog.renameGroup.placeholder': 'Group name',
  'dialog.renameGroup.save': 'Save',
  'dialog.renameGroup.hint': 'Only changes the display name; the directory ({path}) is unchanged. Clear the field to reset.',
