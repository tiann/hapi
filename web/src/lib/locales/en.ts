export default {
  ...
  'newSession.agentUnavailableReason.notFound': 'Not installed or not on PATH',
  'newSession.agentUnavailableReason.invalidConfiguration': 'Invalid runner configuration',
  ...
  'settings.display.newSession': 'New session',
  'settings.display.showUnavailableAgents': 'Show unavailable Agents',
  'settings.display.showUnavailableAgents.desc': 'Keep supported Agents visible in Create Session when they are not installed or available on the selected machine.',
