export default {
  ...
  'settings.chat.steerBehavior': 'While the agent is working',
  'settings.chat.steerBehavior.queue': 'Queue until the turn ends',
  'settings.chat.steerBehavior.steer': 'Steer the running turn',
  'settings.chat.steerBehavior.hint': 'Add Ctrl (⌘) to the send shortcut to use the other one for a single message. Claude sessions only.',
