export default {
  ...
  'sessions.archivedSection': 'Archived project sessions',
  ...
  'settings.display.pinInProgressSessions.desc': 'Move unpinned connected sessions above project folders. Global pins remain above them and project pins stay in their folders. Off keeps everything in directory groups.',
  'settings.display.pinInProgressSessions.mode': 'Pin in-progress session layout',
  'settings.display.pinInProgressSessions.mode.desc': 'By default, Detailed keeps the “In progress” and “Active sessions” sections; Combined groups all active sessions by project directory.',
  'settings.display.pinInProgressSessions.mode.detailed': 'Detailed',
  'settings.display.pinInProgressSessions.mode.combined': 'Combined',
