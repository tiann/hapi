export default {
  ...
  'composer.attachmentPicker.title': 'Add attachment',
  'composer.attachmentPicker.description': 'Choose an attachment source.',
  'composer.attachmentPicker.photos': 'Photos',
  'composer.attachmentPicker.camera': 'Camera',
  'composer.attachmentPicker.files': 'Files',
