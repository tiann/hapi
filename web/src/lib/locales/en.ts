export default {
  ...
  'message.rewind.fallbackTitle': 'Rewind unavailable',
  'message.rewind.fallbackDescription': 'HAPI did not change this session because its native Codex boundary is ambiguous.\nCreate a new session before this point instead? The current session will not be changed.',
  'message.rewind.fallbackFork': 'Fork here',
  'message.rewind.fallbackForking': 'Forking…',
  ...
  'sessions.markAllRead.description': 'This will mark {count} unread sessions as read on this device.',
  'sessions.markAllRead.confirm': 'Confirm',
  'sessions.markAllRead.confirming': 'Marking as read…',
  ...
  'settings.usageQuery.title': 'Agent quota queries',
  'settings.usageQuery.summary': 'Runner-side 5h/7d quota templates',
  'settings.usageQuery.description': 'Configure safe declarative templates for Claude Code, Codex, and Kimi CLI. Reviewed adapters cover Kimi, ZenMux, Zhipu GLM, and MiniMax. Requests run on the selected Runner; API keys never enter the Web UI or Hub database.',
  'settings.usageQuery.target': 'Quota query target',
  'settings.usageQuery.machine': 'Machine',
  'settings.usageQuery.agent': 'Agent',
  'settings.usageQuery.agentClaude': 'Claude Code',
  'settings.usageQuery.agentCodex': 'Codex',
  'settings.usageQuery.agentKimi': 'Kimi CLI',
  'settings.usageQuery.loadingMachines': 'Loading machines…',
  'settings.usageQuery.noMachines': 'No online machines',
  'settings.usageQuery.configuration': 'Quota query configuration',
  'settings.usageQuery.loading': 'Loading Runner settings…',
  'settings.usageQuery.loadFailed': 'Unable to load Runner settings',
  'settings.usageQuery.loadingQuota': 'Loading quota…',
  'settings.usageQuery.quotaUnavailable': 'Quota query unavailable',
  'settings.usageQuery.loadingWindows': 'Loading 5H/7D quota…',
  'settings.usageQuery.quotaFailed': 'Quota query failed',
  'settings.usageQuery.quota': 'Quota:',
  'settings.usageQuery.enabled': 'Enable quota query',
  'settings.usageQuery.enabledDescription': 'When enabled, opening the session context popover can query 5-hour and 7-day quota data on demand.',
  'settings.usageQuery.baseUrlDescription': 'Resolved on the Runner from the selected agent configuration.',
  'settings.usageQuery.apiKeyDescription': 'Resolved on the Runner and never returned to the browser.',
  'settings.usageQuery.configured': 'Configured',
  'settings.usageQuery.notConfigured': 'Not configured',
  'settings.usageQuery.template': 'Template',
  'settings.usageQuery.templateDescription': 'Edit request headers and JSON paths for generic/custom adapters. Reviewed adapters use a fixed response parser. Only requests to the configured base URL origin are allowed.',
  'settings.usageQuery.templateEditor': 'Usage query template JSON',
  'settings.usageQuery.invalidTemplate': 'Template JSON is invalid or missing required fields.',
  'settings.usageQuery.testing': 'Testing…',
  'settings.usageQuery.test': 'Test',
  'settings.usageQuery.saving': 'Saving…',
  'settings.usageQuery.save': 'Save',
  'settings.usageQuery.testResult': 'Test result',
  'settings.usageQuery.testFailed': 'Usage query failed',
  'settings.usageQuery.saveFailed': 'Unable to save usage query settings',
  'settings.usageQuery.documentation': 'Documentation',
  'settings.usageQuery.hapiDocs': 'HAPI quota-query guide',
  'settings.usageQuery.open': 'Open',
  ...
  'settings.general.sessionSummaryInChat.desc': 'Only affects display in chat and copied content; it does not affect summary generation, notifications, or background work records. When on, a status row is shown; when off, it is hidden. Stored messages remain unchanged.',
  ...
  'misc.online': 'online',
  'misc.contextDetails': 'Context popover',
