export default {
  ...
  // DeepSeek Harness session view
  'dsh.sessionLabel': 'DeepSeek Harness',
  'dsh.running': 'running',
  'dsh.idle': 'idle',
  'dsh.pendingApprovals': '{count} pending approval{s}',
  'dsh.reasoning': 'Reasoning',
  'dsh.fork': 'Fork',
  'dsh.forkAtMessage': 'Fork session at this message',
  'dsh.forkingTo': 'Opening forked session',
  'dsh.emptyConversation': 'No messages yet — describe what you want the agent to do.',
  'dsh.error.unknown': 'An error occurred.',
  'dsh.loading': 'Loading…',
  'dsh.send': 'Send',
  'dsh.sending': 'Sending…',
  ...
  'dsh.cancel': 'Cancel',
  'dsh.remove': 'Remove',
  'dsh.jobs': 'Background jobs',
  'dsh.jobStatus.running': 'running',
  'dsh.jobStatus.stopping': 'stopping',
  'dsh.jobStatus.completed': 'completed',
  'dsh.jobStatus.killed': 'killed',
  'dsh.jobStatus.failed': 'failed',
  'dsh.goalStatus.active': 'active',
  'dsh.goalStatus.paused': 'paused',
  'dsh.goalStatus.complete': 'complete',
  'dsh.goalStatus.cleared': 'cleared',
  'dsh.goalRound': 'round {round}',
  'dsh.goalPause': 'Pause',
  'dsh.goalResume': 'Resume',
  'dsh.goalComplete': 'Complete',
  'dsh.goalClear': 'Clear',
  'dsh.questionsTitle': 'The agent needs your input',
  'dsh.questionCustomPlaceholder': 'Other (optional)',
  'dsh.submitAnswer': 'Submit',
  'dsh.submitting': 'Submitting…',
  'dsh.allowOnce': 'Allow once',
  'dsh.deny': 'Deny',
  'dsh.approvalUnknownTool': 'Tool permission',
  'dsh.model': 'Model',
  'dsh.mode': 'Mode',
  'dsh.mode.standard': 'Standard mode',
  'dsh.mode.code': 'Code mode',
  'dsh.mode.minimal': 'Minimal mode',
  'dsh.mode.cordis': 'Creator mode',
  ...
  'dsh.skills': 'Skills',
  'dsh.subagents': 'Subagents',
  'dsh.loadSubagents': 'List subagents',
  'dsh.noSubagents': 'No subagents yet.',
  'dsh.subagentRunning': 'running',
  'dsh.refresh': 'Refresh',
  'dsh.subagentRunningCount': '{count} running',
  'dsh.subagentHasChildren': 'has children',
  'dsh.subagentIdle': 'idle',
  'dsh.toolCall': 'tool call',
  'dsh.toolResult': 'tool result',
