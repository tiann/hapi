export default {
  ...
  'scratchlist.emptyHint': 'Park notes, drafts, or ideas here. Nothing is sent automatically.',
  'scratchlist.drawerHint': 'Use the composer below to add a draft. Click a text block to edit it; long-press and drag to reorder.',
  'scratchlist.drawerHintAriaLabel': 'Show scratchlist usage tips',
  ...
  'scratchlist.action.editEntry': 'Edit scratchlist entry',
  'scratchlist.action.dragToReorder': 'Long-press and drag to reorder',
  'scratchlist.action.copy': 'Copy text',
  'scratchlist.action.copied': 'Copied',
  'scratchlist.action.delete': 'Delete entry',
  'scratchlist.action.more': 'More actions',
  'scratchlist.action.menuAriaLabel': 'Scratchlist entry actions',
  'scratchlist.action.sendNow': 'Send now',
  'scratchlist.action.scheduleSend': 'Schedule send',
  'scratchlist.confirmDelete.title': 'Delete draft?',
  'scratchlist.confirmDelete.description': 'Delete this draft? This action cannot be undone.',
  'scratchlist.confirmDelete.attachmentTitle': 'Delete attachment?',
  'scratchlist.confirmDelete.attachmentDescription': 'Delete “{name}”? This action cannot be undone.',
