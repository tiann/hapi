export default {
  ...
  'dshImport.inline.title': 'Import DeepSeek Harness history',
  'dshImport.inline.description': 'Optional: choose an existing DSH session to import and continue.',
  'dshImport.inline.clear': 'Clear',
  'dshImport.inline.choose': 'Choose history',
  'dshImport.dialog.title': 'Import DeepSeek Harness sessions',
  'dshImport.dialog.description': 'Select DSH histories. One selection is continued now; multiple selections are imported in the background.',
  'dshImport.dialog.concurrentWarning': 'HAPI continues the same native DSH session. Avoid sending from another DSH client at the same time unless you intentionally want to share that live conversation.',
  'dshImport.loading': 'Loading DeepSeek Harness sessions…',
  'dshImport.empty': 'No importable DeepSeek Harness sessions found. Make sure dsh web is running.',
  'dshImport.selectedCount': '{n} selected',
  'dshImport.clearAll': 'Clear all',
  'dshImport.selectAll': 'Select all',
  'dshImport.allDirectories': 'All directories',
  'dshImport.search': 'Search title, prompt, path, model, or ID',
  'dshImport.imported': 'Imported',
  'dshImport.needsAttention': 'Needs attention',
  'dshImport.messages': 'items',
  'dshImport.importing': 'Importing…',
  'dshImport.confirm': 'Import',
  'dshImport.success.title': 'DeepSeek Harness sessions imported',
  'dshImport.success.body': 'Imported {n} DeepSeek Harness sessions.',
  'dshImport.failed.title': 'DeepSeek Harness import failed',
  'dshImport.failed.body': 'Failed to import DeepSeek Harness history.',
