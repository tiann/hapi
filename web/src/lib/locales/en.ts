export default {
  ...
  'newSession.permissionMode.desc': 'Choose the sandbox and approval behavior reported by the selected machine.',
  'newSession.provider.experimental': 'Experimental',
  'newSession.provider.readinessMissing': '{agent} readiness is unavailable. Update or restart HAPI Runner.',
  'newSession.provider.readinessStale': '{agent} readiness is stale. Update or restart HAPI Runner.',
  'newSession.provider.notInstalled': '{agent} is not installed.',
  'newSession.provider.notAuthenticated': '{agent} is not authenticated.',
  'newSession.provider.versionUnsupported': '{agent} needs a supported version.',
  'newSession.provider.probeFailed': '{agent} readiness could not be checked.',
  'newSession.provider.modelUnavailable': 'The selected model is not available for {agent}.',
  'newSession.provider.effortUnavailable': 'The selected effort is not available for {agent}.',
  'newSession.provider.modeUnavailable': 'The selected permission mode is not available for {agent}.',
  'newSession.provider.resumeUnavailable': 'Resume is not available for {agent} on this machine.',
  ...
  'session.selectionChangedDuringCreate': 'The machine or session settings changed during preflight. Review them and create again.',
  ...
  'tool.input': 'Input',
  'tool.result': 'Result',
  'tool.rawInput': 'Raw input payload',
  'tool.rawResult': 'Raw result payload',
  ...
  'misc.returnToLatest': 'Return to latest',
