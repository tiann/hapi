export default {
  ...
  'studio.action.create': 'Create studio',
  'studio.loading': 'Loading studio…',
  'studio.notFound': 'This studio is unavailable or its link was revoked.',
  'studio.back': 'Back to session',
  'studio.owner.title': 'Host controls',
  'studio.owner.shareLink': 'Share link',
  'studio.owner.copy': 'Copy',
  ...
  'studio.mode.view': 'View only',
  'studio.mode.contribute': 'Contribute',
  'studio.post.status.open': 'Pending',
  'studio.post.status.submitted': 'Submitted',
  'studio.post.status.dismissed': 'Dismissed',
  'studio.post.kind.discussion': 'Discuss',
  'studio.post.kind.suggestion': 'Suggest',
