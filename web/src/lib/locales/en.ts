export default {
  ...
  'settings.voice.provider': 'Voice Provider',
  'settings.voice.language': 'Voice Language',
  'settings.voice.autoDetect': 'Auto-detect',
  'settings.voice.geminiApiKey': 'Gemini API Key',
  'settings.voice.geminiApiKeyPlaceholder': 'Leave empty to use server config',
  'settings.voice.geminiApiKeyHint': 'Optional. Overrides the server-side GEMINI_API_KEY.',
  'settings.voice.geminiUrl': 'API / Proxy URL',
  'settings.voice.geminiUrlPlaceholder': 'googleapis.com or CF Workers URL',
  'settings.voice.geminiUrlHint': 'Optional. Use a CF Workers proxy URL or leave empty for direct Google API.',
