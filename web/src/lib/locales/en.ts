export default {
  ...
  'settings.display.sessionToolbar.title': 'Session list toolbar',
  'settings.display.sessionToolbar.description': 'Arrange optional sidebar actions. Settings and New session stay fixed so this editor is always reachable.',
  'settings.display.sessionToolbar.searchLayout': 'Search layout',
  'settings.display.sessionToolbar.searchLayout.icon': 'Search icon',
  'settings.display.sessionToolbar.searchLayout.field': 'Always-visible field',
  'settings.display.sessionToolbar.order': 'Tool order',
  'settings.display.sessionToolbar.previewHint': 'Drag tools to reorder or move them between the left, right, and hidden groups. Select a tool for keyboard-friendly controls.',
  'settings.display.sessionToolbar.reset': 'Reset',
  'settings.display.sessionToolbar.hidden': 'Hidden tools',
  'settings.display.sessionToolbar.emptyHidden': 'Drag tools here to hide them',
  'settings.display.sessionToolbar.leftGroup': 'Left group',
  'settings.display.sessionToolbar.rightGroup': 'Right group',
  'settings.display.sessionToolbar.moveEarlier': 'Move earlier',
  'settings.display.sessionToolbar.moveLater': 'Move later',
  'settings.display.sessionToolbar.hide': 'Hide',
  'settings.display.sessionToolbar.show': 'Show',
  'settings.display.sessionToolbar.fixedHint': 'Settings and New session are fixed. Browse appears only when a runner exposes workspace roots; the machine filter appears when multiple machines are available.',
  'settings.display.sessionToolbar.dateEmbedded': 'Date filter (shown inside the search field in this layout)',
  'settings.display.sessionToolbar.item.search': 'Search sessions',
  'settings.display.sessionToolbar.item.dateFilter': 'Date filter',
  'settings.display.sessionToolbar.item.machineFilter': 'Machine filter',
  'settings.display.sessionToolbar.item.codexImport': 'Import Codex history',
  'settings.display.sessionToolbar.item.refresh': 'Refresh sessions',
  'settings.display.sessionToolbar.item.browse': 'Browse workspaces',
  ...
  'sessions.toolbar.item.refresh': 'Refresh sessions',
