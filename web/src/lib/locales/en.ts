export default {
  ...
  'opencodeSync.inline.title': 'Import OpenCode history',
  'opencodeSync.inline.description': 'Optional: choose an existing local OpenCode session to import and continue.',
  'opencodeSync.inline.clear': 'Clear',
  'opencodeSync.inline.choose': 'Choose history',
  'opencodeSync.dialog.title': 'Import OpenCode sessions',
  'opencodeSync.dialog.description': 'Select local OpenCode histories. One selection is continued now; multiple selections are imported in the background.',
  'opencodeSync.dialog.concurrentWarning': 'Multiple processes can open the same OpenCode session, but avoid writing from stale copies. Before continuing in HAPI, reload or close any other OpenCode process to avoid an unintended branch.',
  'opencodeSync.loading': 'Scanning OpenCode sessions…',
  'opencodeSync.empty': 'No importable OpenCode sessions found.',
  'opencodeSync.selectedCount': '{n} selected',
  'opencodeSync.clearAll': 'Clear all',
  'opencodeSync.selectAll': 'Select all',
  'opencodeSync.allDirectories': 'All directories',
  'opencodeSync.search': 'Search title, prompt, path, or ID',
  'opencodeSync.imported': 'Imported',
  'opencodeSync.importing': 'Importing…',
  'opencodeSync.confirm': 'Import',
  'opencodeSync.success.title': 'OpenCode sessions imported',
  'opencodeSync.success.body': 'Imported {n} OpenCode sessions.',
  'opencodeSync.failed.title': 'OpenCode import failed',
  'opencodeSync.failed.body': 'Failed to import OpenCode history.',
  'opencodeSync.failed.partial': '{failed} sessions failed: {reason}',
  'opencodeSync.error.diverged': 'The local OpenCode branch changed after the previous import. Review the session before continuing.',
  'opencodeSync.error.active': 'Stop the active Hapi OpenCode session before importing newer native history.',
