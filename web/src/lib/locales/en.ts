export default {
  ...
  'runner.skew.banner.handoffHint': 'After you upgrade the CLI on a host, that runner normally self-restarts (version handoff). Restart here is only needed if handoff is stuck or disabled (HAPI_DISABLE_VERSION_HANDOFF=1). Hub never downloads packages to remotes.',
