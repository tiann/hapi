export default {
  ...
  'codexSync.tooltip': 'Sync session to Codex client',
  'codexSync.confirm.title': 'Sync session',
  'codexSync.confirm.description': 'Sync this session to the Codex client?',
  'codexSync.confirm.confirm': 'Sync',
  'codexSync.confirm.confirming': 'Syncing…',
  'codexSync.success.title': 'Sync complete',
  'codexSync.success.body': 'Session content has been synced to the Codex client.',
  'codexSync.error.timeout': 'Operation timed out',
  'codexSync.failed.title': 'Session sync failed',
  'codexSync.failed.body': 'Failed to run the sync script.',
  'codexSync.failed.bodyWithReason': 'Sync failed: {reason}',
  'codexSync.restart.title': 'Sync complete',
  'codexSync.restart.description': 'Session content has been synced to the Codex client.\nRestart Codex client to refresh sessions?',
