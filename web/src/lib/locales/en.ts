export default {
  ...
  'sessions.search.scope.metadata': 'Default',
  'sessions.search.scope.content': 'Content',
  'sessions.search.scope.toggle': 'Search scope',
  ...
  'session.inChatSearch.open': 'Search in this conversation',
  'session.inChatSearch.openTitle': 'Search in this conversation (Ctrl/Cmd+Shift+F)',
  'session.inChatSearch.inputLabel': 'Find in this conversation',
  'session.inChatSearch.placeholder': 'Find in this conversation…',
  'session.inChatSearch.minQuery': 'Enter at least 2 characters to search message content.',
  'session.inChatSearch.loading': 'Searching this conversation…',
  'session.inChatSearch.error': 'Conversation search failed.',
  'session.inChatSearch.noResults': 'No messages match in this conversation.',
  'session.inChatSearch.results': '{shown} of {total}',
  'session.inChatSearch.roleAssistant': 'Assistant',
  'session.inChatSearch.fueTitle': 'Find in this conversation',
  'session.inChatSearch.fueBody': 'Search the open chat with ranked results, pick a hit, and jump straight to that turn. Sidebar Content search still finds which session.',
  ...
  'misc.locatingMessage': 'Locating message…',
  'misc.searchMatchNavigation': 'Search match navigation',
  'misc.searchMatches': '{current}/{total}',
  'misc.previousSearchMatch': 'Previous match',
  'misc.nextSearchMatch': 'Next match',
  'misc.closeSearch': 'Close content search',
