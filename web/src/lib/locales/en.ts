export default {
  ...
  'misc.contextAgentDetails': 'Agent context details',
  'misc.contextAgentDetailsTitle': 'Agent details',
  ...
  'misc.contextWindow': 'Context window',
  'misc.contextInput': 'Input',
  'misc.contextOutput': 'Output',
  'misc.contextCacheRead': 'Cache read',
  'misc.contextCacheWrite': 'Cache write',
  'misc.contextReasoning': 'Reasoning',
  'misc.contextSessionTotal': 'Session total',
  'misc.contextProvider': 'Provider',
  'misc.contextCategories': 'Context categories',
  'misc.contextResources': 'Resources',
  'misc.contextMemoryFiles': 'Memory files',
  'misc.contextMemoryFile': 'Memory file',
  'misc.contextSkills': 'Skills',
  'misc.contextAgents': 'Agents',
  'misc.contextMcpTools': 'MCP tools',
  'misc.contextSystemTools': 'System tools',
  'misc.contextTool': 'Tool',
  'misc.contextSlashCommands': 'Agent commands',
  'misc.contextCommand': 'Command',
  'misc.contextRuntime': 'Runtime',
  'misc.contextSandbox': 'Sandbox',
  'misc.contextApproval': 'Approval',
  'misc.contextServiceTier': 'Service tier',
  'misc.contextInstructionSources': 'Instruction sources',
  'misc.contextMcpServers': 'MCP servers',
  'misc.contextMcpServer': 'MCP server',
  'misc.contextSource': 'Source',
  'misc.contextNoDetails': 'This agent has not reported additional context details yet.',
