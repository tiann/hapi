export default {
  ...
  'dialog.rename.generateErrorWithReason': 'Failed to generate a title: {reason}',
  'dialog.rename.generateProviderErrorWithStatus': 'Title provider request failed (HTTP {status}): {reason}',
  'dialog.rename.generateProviderError': 'Title provider request failed: {reason}',
  'dialog.rename.providerReason.requestRejected': 'request rejected',
  'dialog.rename.providerReason.authenticationFailed': 'authentication failed',
  'dialog.rename.providerReason.accessDenied': 'access denied',
  'dialog.rename.providerReason.endpointOrModelNotFound': 'endpoint or model not found',
  'dialog.rename.providerReason.requestTimedOut': 'request timed out',
  'dialog.rename.providerReason.rateLimited': 'rate limited',
  'dialog.rename.providerReason.serviceUnavailable': 'provider service unavailable',
  'dialog.rename.providerReason.connectionFailed': 'connection failed',
  'dialog.rename.providerReason.emptyResponse': 'empty response',
  'dialog.rename.providerReason.invalidResponse': 'invalid response',
