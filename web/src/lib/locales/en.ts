export default {
  ...
  'runner.skew.banner.autoUpgradeHint': 'Opt-in is only “hub may stop-runner when a newer CLI is already installed on that machine.” It never downloads or installs packages remotely. Enable with HAPI_AUTO_UPGRADE_RUNNERS=1 or autoUpgradeRunners: true in hub settings.json (default off).',
