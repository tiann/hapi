export default {
  ...
  'tool.exitPlanMode.title': 'Execute Plan',
  'tool.exitPlanMode.badge': 'Implementation',
  'tool.exitPlanMode.prompt': 'Choose how to start implementation after leaving plan mode.',
  ...
  'tool.exitPlanMode.clearContext.description': 'Start implementation in a new Claude session.',
  'tool.exitPlanMode.permissionMode.prompt': 'Choose the permission mode for implementation.',
  'tool.exitPlanMode.permissionMode.default.title': 'Normal',
  'tool.exitPlanMode.permissionMode.default.description': 'Ask for approval on each action.',
  'tool.exitPlanMode.permissionMode.acceptEdits.title': 'Accept edits',
  'tool.exitPlanMode.permissionMode.acceptEdits.description': 'Auto-approve file edits, ask for other actions.',
  'tool.exitPlanMode.permissionMode.bypassPermissions.title': 'YOLO',
  'tool.exitPlanMode.permissionMode.bypassPermissions.description': 'Auto-approve all actions without asking.',
