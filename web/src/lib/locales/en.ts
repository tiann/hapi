export default {
  ...
  'toolGroup.mobileToolCount': 'Actions {n}',
  ...
  'settings.chat.toolCardDisplay': 'Display Style',
  'settings.chat.toolCardDisplay.grouped': 'Combined',
  'settings.chat.toolCardDisplay.compact': 'Compact',
  'settings.chat.toolCardDisplay.detailed': 'Detailed',
  'settings.chat.toolCardDisplay.preview': 'Preview',
  'settings.chat.toolCardDisplay.preview.grouped': 'Combine consecutive tool calls into one card',
  'settings.chat.toolCardDisplay.preview.compact': 'Show each tool separately; terminal cards show commands only',
  'settings.chat.toolCardDisplay.preview.detailed': 'Show each tool separately; terminal cards include an output preview',
  'settings.chat.codexExplorationCollapsed': 'Collapse explored tool groups',
  'settings.chat.codexExplorationCollapsed.desc': 'Collapse Codex read and search activity; click to view details.',
  ...
  'settings.chat.groupedToolBackground': 'Combined Tool Use Background',
