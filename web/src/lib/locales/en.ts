export default {
  ...
  'composer.textContext.button': 'Add text context',
  'composer.textContext.title': 'Add text context',
  'composer.textContext.description': 'Store supporting text as a file attachment, then write the request in the message composer.',
  'composer.textContext.name': 'Name',
  'composer.textContext.namePlaceholder': 'Optional attachment name',
  'composer.textContext.content': 'Context',
  'composer.textContext.placeholder': 'Paste or type supporting context here',
  'composer.textContext.stats': '{characters} characters · {lines} lines',
  'composer.textContext.add': 'Add as context',
  'composer.textContext.adding': 'Adding…',
  'composer.textContext.addFailed': 'Failed to add text context',
  'message.user.expand': 'Expand full message',
  'message.user.collapse': 'Collapse message',
  ...
  'settings.chat.textContext.characterThreshold': 'Auto-attach character threshold',
  'settings.chat.textContext.characterThreshold.desc': 'Pasted text at or above this many characters becomes a UTF-8 .txt attachment.',
  'settings.chat.textContext.lineThreshold': 'Auto-attach line threshold',
  'settings.chat.textContext.lineThreshold.desc': 'Pasted text with more than this many lines becomes a UTF-8 .txt attachment.',
  'settings.chat.textContext.characters': 'chars',
  'settings.chat.textContext.lines': 'lines',
  ...
  'settings.chat.composerToolbar.item.textContext': 'Add text context',
