export default {
  ...
  'agentImport.tooltip': 'Import agent sessions into Hapi from online runners across your estate',
  ...
  'agentImport.hubLocalScopeHint': 'Scans every online runner via machine RPC and merges results. You do not pick a machine — each chat keeps its owning runner for import.',
  ...
  'cursorSync.confirm.loading': 'Loading Cursor chats from online runners…',
  'cursorSync.confirm.empty': 'No Cursor chats found on online runners',
  'cursorSync.confirm.emptyForWorkdir': 'No Cursor chats in this workspace on online runners',
  ...
  'cursorSync.confirm.acpStrictHint': 'Imports run agent acp verify-probe on the chat\'s owning runner before any Hapi row is created. Chats that fail are reported per-row with a reason; no partial state is left behind.',
  ...
  'claudeSync.confirm.description': 'Choose Claude sessions to import into Hapi from online runners across your estate',
  ...
  'claudeSync.confirm.empty': 'No Claude sessions found on online runners',
  ...
  'claudeSync.confirm.emptyForWorkdir': 'No Claude sessions in this work directory on online runners',
  'claudeSync.confirm.confirm': 'Import',
  'claudeSync.confirm.confirming': 'Importing…',
  'claudeSync.confirm.loading': 'Loading Claude sessions from online runners…',
