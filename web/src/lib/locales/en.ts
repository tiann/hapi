export default {
  ...
  'session.item.prChipWithStatus': 'PR #{number} ({status})',
  'session.item.prLinked': 'linked',
  'session.item.prChecked': 'checked {time}',
  'session.item.prStale': 'stale',
  'session.item.prStatus.merged': 'merged',
  'session.item.prStatus.closed': 'closed',
  'session.item.prStatus.draft': 'draft',
  'session.item.prStatus.checksFailed': 'checks failed',
  'session.item.prStatus.conflicts': 'conflicts',
  'session.item.prStatus.mergeBlocked': 'merge blocked',
  'session.item.prStatus.checksRunning': 'checks running',
  'session.item.prStatus.unstable': 'unstable',
  'session.item.prStatus.behindBase': 'behind base',
  'session.item.prStatus.readyToMerge': 'ready to merge',
  'session.item.prStatus.mergeable': 'mergeable',
  'session.item.prStatus.checksPassed': 'checks passed',
