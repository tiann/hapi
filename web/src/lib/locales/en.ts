export default {
  ...
  'settings.display.sessionHeader.description': 'Choose which details appear below the session title. Mobile shows enabled Agent details plus the highest-priority available detail.',
  'settings.display.sessionHeader.showLabels': 'Show field labels',
  'settings.display.sessionHeader.agent': 'Agent',
  'settings.display.sessionHeader.agentIcon': 'Agent icon',
