export default {
  ...
  'dialog.fork.yoloDescription': 'Run commands without asking for permission',
  'dialog.fork.confirm': 'Fork',
  'dialog.fork.success': 'Session forked successfully',
  'dialog.fork.error': 'Failed to fork session',
  'dialog.reload.title': 'Reload Session',
  'dialog.reload.description': 'Restart the session process to apply new settings or CLI updates',
  'dialog.reload.yoloLabel': 'Enable YOLO mode',
  'dialog.reload.yoloDescription': 'Run commands without asking for permission',
  'dialog.reload.forceLabel': 'Force reload',
  'dialog.reload.forceDescription': 'Stop current operation immediately',
