export default {
  ...
  'scratchlist.toggleTooltip': 'Scratchlist — park notes & drafts (click to open)',
  'scratchlist.sendToScratchlist': 'Send to scratchlist',
  'scratchlist.fueTitle': 'New: Scratchlist',
  'scratchlist.fueBody': 'Park notes & drafts here without sending. The Send button glows amber while you stash; click the icon again to leave.',
