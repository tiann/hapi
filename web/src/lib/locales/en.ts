export default {
  ...
  'newSession.permissionMode.default': 'Default',
  'newSession.permissionMode.readOnly': 'Read Only',
  'newSession.permissionMode.safeYolo': 'Safe YOLO',
  'newSession.permissionMode.yolo': 'YOLO',
  ...
  'settings.codexProfiles.title': 'Codex Profiles',
  'settings.codexProfiles.machine': 'Machine',
  'settings.codexProfiles.default': 'Default profile',
  'settings.codexProfiles.default.none': 'No default profile',
  'settings.codexProfiles.default.badge': 'Default',
  'settings.codexProfiles.loading': 'Loading Codex profiles…',
  'settings.codexProfiles.empty': 'No Codex profiles on this machine yet.',
  'settings.codexProfiles.form.new': 'New profile',
  'settings.codexProfiles.form.edit': 'Edit profile',
  'settings.codexProfiles.form.id': 'Profile ID',
  'settings.codexProfiles.form.label': 'Label',
  'settings.codexProfiles.form.model': 'Model',
  'settings.codexProfiles.form.reasoningEffort': 'Reasoning effort',
  'settings.codexProfiles.form.reasoningEffort.minimal': 'Minimal',
  'settings.codexProfiles.form.reasoningEffort.low': 'Low',
  'settings.codexProfiles.form.reasoningEffort.medium': 'Medium',
  'settings.codexProfiles.form.reasoningEffort.high': 'High',
  'settings.codexProfiles.form.reasoningEffort.xhigh': 'XHigh',
  'settings.codexProfiles.form.permissionMode': 'Permission mode',
  'settings.codexProfiles.form.collaborationMode': 'Collaboration mode',
  'settings.codexProfiles.form.collaborationMode.default': 'Default',
  'settings.codexProfiles.form.collaborationMode.plan': 'Plan',
  'settings.codexProfiles.form.sessionType': 'Session type',
  'settings.codexProfiles.form.unset': 'Use launch default',
  'settings.codexProfiles.form.create': 'Create profile',
  'settings.codexProfiles.form.update': 'Save changes',
  'settings.codexProfiles.form.cancel': 'Reset form',
  'settings.codexProfiles.form.editAction': 'Edit',
  'settings.codexProfiles.form.deleteAction': 'Delete',
  'settings.codexProfiles.form.validation.idRequired': 'Profile ID is required.',
  'settings.codexProfiles.form.validation.labelRequired': 'Profile label is required.',
  'settings.codexProfiles.form.validation.idDuplicate': 'Profile ID already exists.',
  'settings.codexProfiles.form.saveError': 'Failed to save Codex profiles.',
