export default {
  ...
  'settings.general.peerSpawn.agent': 'Peer spawn agent',
  'settings.general.peerSpawn.agent.desc': 'Default flavor for MCP spawn_peer and hapi spawn-peer when the tool omits agent.',
  'settings.general.peerSpawn.permissionMode': 'Peer spawn permission mode',
  'settings.general.peerSpawn.permissionMode.desc': 'Default permission mode for peer spawns (yolo maps to each flavor\'s auto-approve equivalent).',
  'settings.general.peerSpawn.model': 'Peer spawn model',
  'settings.general.peerSpawn.model.desc': 'Default model id for the selected peer-spawn agent (per-flavor; blur to save).',
