export default {
  ...
  'settings.providers.description': 'Manage machine-local API profiles for supported agents. Secrets never persist in the hub.',
  'settings.providers.summary': 'Machine-local agent credentials',
  'settings.providers.machine': 'Machine',
  'settings.providers.agent': 'Agent',
  'settings.providers.profiles': 'Profiles',
  'settings.providers.system': 'System / agent login',
  'settings.providers.systemDescription': 'Use the agent’s existing login and environment.',
  'settings.providers.default': 'Default',
  'settings.providers.setDefault': 'Set default',
  'settings.providers.official': 'Official endpoint',
  'settings.providers.disabled': 'Disabled',
  'settings.providers.empty': 'No managed profiles yet.',
  'settings.providers.add': 'Add profile',
  'settings.providers.edit': 'Edit profile',
  'settings.providers.name': 'Profile name',
  'settings.providers.baseUrl': 'Base URL (optional)',
  'settings.providers.apiKey': 'API key or token',
  'settings.providers.secretUnchanged': 'Leave blank to keep the current secret',
  'settings.providers.defaultModel': 'Default model (optional)',
  'settings.providers.enabled': 'Enabled',
  'settings.providers.connection.healthy': 'Connected',
  'settings.providers.connection.unhealthy': 'Connection failed',
  'settings.providers.connection.unverified': 'Not checked',
  ...
  'newSession.provider.label': 'API provider',
  'newSession.provider.machineDefault': 'Machine default',
  'newSession.provider.system': 'System / agent login',
  'newSession.provider.machineDefaultDescription': 'Uses the machine default profile when one is configured; otherwise uses the agent login.',
  'newSession.provider.systemDescription': 'Uses the agent login and existing environment variables.',
  'newSession.provider.restartDescription': 'The selected profile is applied when this session starts. Switching a provider requires a new or restarted session.',
