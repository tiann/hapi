export default {
  ...
  'settings.general.agents.description': 'Hub-wide defaults for New Session create and peer spawn (MCP spawn_peer / hapi spawn-peer).',
  'settings.general.peerSpawn.agent': 'Default agent',
  'settings.general.peerSpawn.agent.desc': 'Default flavor for New Session and peer spawn when the caller omits agent.',
  'settings.general.peerSpawn.permissionMode': 'Default permission mode',
  'settings.general.peerSpawn.permissionMode.desc': 'Default permission mode for New Session and peer spawns (yolo maps to each flavor\'s auto-approve equivalent).',
  'settings.general.peerSpawn.model': 'Default model',
  'settings.general.peerSpawn.model.desc': 'Default model id for the selected agent (per-flavor; blur to save). Used by New Session and peer spawn when model is omitted.',
