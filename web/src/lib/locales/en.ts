export default {
  ...
  'files.page.openRecycleBin': 'Open Recycle Bin',
  ...
  'file.page.moveToRecycleBin': 'Move file to Recycle Bin',
  ...
  // HAPI Recycle Bin
  'recycleBin.title': 'HAPI Recycle Bin',
  'recycleBin.itemCount': '{count} item(s)',
  'recycleBin.loading': 'Loading Recycle Bin…',
  'recycleBin.emptyState': 'The Recycle Bin is empty',
  'recycleBin.expires': 'Expires {date} · {days} day(s) left',
  'recycleBin.preview': 'Preview',
  'recycleBin.previewLoading': 'Loading preview…',
  'recycleBin.previewUnavailable': 'Preview unavailable.',
  'recycleBin.restore': 'Restore',
  'recycleBin.restoring': 'Restoring…',
  'recycleBin.purge': 'Delete',
  'recycleBin.empty': 'Empty',
  'recycleBin.moveConfirmTitle': 'Move file to Recycle Bin?',
  'recycleBin.moveConfirmDescription': 'Move "{path}" to the HAPI Recycle Bin. It can be restored for up to {days} day(s).',
  'recycleBin.moveConfirmDescriptionUnknown': 'Move "{path}" to the HAPI Recycle Bin. It can be restored until the configured retention period expires.',
  'recycleBin.moveConfirm': 'Move',
  'recycleBin.moveConfirming': 'Moving…',
  'recycleBin.purgeConfirmTitle': 'Delete file permanently?',
  'recycleBin.purgeConfirmDescription': 'Permanently delete "{name}" at "{path}" from the HAPI Recycle Bin. This cannot be undone.',
  'recycleBin.purgeConfirm': 'Delete permanently',
  'recycleBin.purgeConfirming': 'Deleting…',
  'recycleBin.emptyConfirmTitle': 'Empty Recycle Bin?',
  'recycleBin.emptyConfirmDescription': 'Permanently delete {count} item(s) from the HAPI Recycle Bin. This cannot be undone.',
  'recycleBin.emptyConfirm': 'Empty Recycle Bin',
  'recycleBin.emptyConfirming': 'Emptying…',
  'recycleBin.restoreConflictTitle': 'Restore target already exists',
  'recycleBin.restoreConflictDescription': 'A file named "{name}" already exists at "{path}". Choose how to restore it.',
  'recycleBin.restoreConflictOverwrite': 'Overwrite existing file',
  'recycleBin.restoreConflictNewName': 'Restore with a new name',
  'recycleBin.restoreConflictCancel': 'Cancel restore',
  'recycleBin.error.list': 'Failed to load the HAPI Recycle Bin.',
  'recycleBin.error.move': 'Failed to move the file to the HAPI Recycle Bin.',
  'recycleBin.error.preview': 'Failed to preview the recycle-bin entry.',
  'recycleBin.error.restore': 'Failed to restore the recycle-bin entry.',
  'recycleBin.error.purge': 'Failed to permanently delete the recycle-bin entry.',
  'recycleBin.error.empty': 'Failed to empty the HAPI Recycle Bin.',
