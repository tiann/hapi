export default {
  ...
  'settings.telegram.botToken.placeholder': 'Enter your Telegram bot token from @BotFather',
  'settings.telegram.botToken.help': 'Get a token from @BotFather on Telegram',
  'settings.telegram.publicUrl': 'Public URL',
  'settings.telegram.publicUrl.placeholder': 'https://your-domain.com',
  'settings.telegram.notifications': 'Notifications',
  'settings.telegram.notifications.enabled': 'Enabled',
  'settings.telegram.notifications.disabled': 'Disabled',
  'settings.telegram.save': 'Save Configuration',
  'settings.telegram.saving': 'Saving…',
  'settings.telegram.saved': 'Configuration saved',
  'settings.telegram.saveError': 'Failed to save configuration',
  'settings.telegram.restartRequired': 'Please restart the hub for changes to take effect',
  'settings.telegram.tokenSource.env': 'From environment variable',
  'settings.telegram.tokenSource.file': 'From settings file',
  'settings.telegram.tokenSource.default': 'Not configured',
  'settings.telegram.removeToken': 'Remove Token',
  'settings.telegram.removing': 'Removing…',
  'settings.telegram.confirmRemove': 'Are you sure you want to remove the Telegram bot token?',
