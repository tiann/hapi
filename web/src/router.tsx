            ...
            >
                <div className="flex min-h-0 flex-1 flex-col pt-[env(safe-area-inset-top)]">
                    ...
                    <SessionList
                        ...
                        onImportCodex={() => navigate({ to: '/sessions/new', search: { codexImport: true } })}
...
function NewSessionPage() {
    ...
    const { t } = useTranslation()
    const { directory: initialDirectory, machineId: initialMachineId, shareTransferId, codexImport } = newSessionRoute.useSearch()
        ...
        <div className="flex h-full min-h-0 flex-col">
            ...
            >
                ...
                <NewSession
                    ...
                    initialCodexImportOpen={codexImport}
                />
            </div>
        </div>
    )
...
const newSessionRoute = createRoute({
    ...
    validateSearch: (search: Record<string, unknown>): NewSessionSearch => {
        ...
        if (search.codexImport === true || search.codexImport === 'true') {
            result.codexImport = true
        }
        return result
    },
