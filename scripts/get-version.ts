...
// Check if we're generating a TypeScript file (for embedding) or JSON (for runtime)
const args = process.argv.slice(2)
if (args.includes('--ts')) {
    console.log(`// This file is auto-generated by scripts/get-version.ts`)
    console.log(`// Do not edit manually`)
    console.log(`export default ${JSON.stringify(version, null, 2)}`)
} else {
